 ...
 * child component. May contain <code>Pane</code>s as children.
 */
public class WindowPane extends Component
    ...
    /**
     * A constant for the <code>defaultCloseOperation</code> property indicating
     * that nothing should be done when the user attempts to close a window.
     */
    public static final int DO_NOTHING_ON_CLOSE = 0;

    /**
     * A constant for the <code>defaultCloseOperation</code> property indicating
     * that a window should be hidden when the user attempts to close it.
     */
    public static final int HIDE_ON_CLOSE = 1;

    /**
     * A constant for the <code>defaultCloseOperation</code> property indicating
     * that a window should be removed from the component hierarchy when a user
    ...
    /**
     * Creates a new <code>WindowPane</code> with the specified title and
     * dimensions.
     *
    ...
    /**
     * Adds a <code>WindowPaneListener</code> (or
     * <code>WindowPaneControlListener</code>) to receive event notifications.
     *
    ...
    /**
     * Notifies <code>WindowPaneListener</code>s that the user has requested to
     * close this <code>WindowPane</code>.
     */
    ...
    /**
     * Notifies <code>WindowPaneListener</code>s that the user has maximized the
    ...
    /**
     * Notifies <code>WindowPaneListener</code>s that the user has minimized the
     * <code>WindowPane</code>
     */
    ...
    /**
     * Returns the animation time for the window closing effect. A value of 0
     * (the default) indicates the window will be immediately closed.
     *
    ...
    /**
     * Returns the spacing between the window control icons (e.g., close,
    ...
    /**
     * Returns the inset margin around the window controls (e.g., close,
     * minimize, and maximize buttons)
     *
     * @return the inset margin
     */
    ...
    /**
     * Returns the configured height of the overall window, including its
     * border.
     *
     * @return the height
     */
    ...
    /**
     * Returns the animation time for the window opening effect. A value of 0
     * (the default) indicates the window will be immediately opened.
     *
     * @return the animation time, in milliseconds
     */
    ...
    /**
     * Removes a <code>WindowPaneListener</code> (or
     * <code>WindowPaneControlListener</code>) from receiving event
     * notifications.
     *
    ...
    public void setClosable(boolean newValue) {
        set(PROPERTY_CLOSABLE, newValue);
    }

    /**
     * Sets the animation time for the window closing effect. A value of 0 (the
     * default) indicates the window will be immediately closed.
     *
     * @param newValue the new animation time, in milliseconds
     */
    public void setCloseAnimationTime(int newValue) {
        set(PROPERTY_CLOSE_ANIMATION_TIME, newValue);
    }
    ...
    /**
     * Sets the content height of the <code>WindowPane</code>. This value will
     * be overridden by the <code>height</code> property, if it is set.
     *
    ...
    /**
     * Sets the content width of the <code>WindowPane</code>. This value will be
     * overridden by the <code>width</code> property, if it is set.
     *
    ...
    /**
     * Sets the spacing between the window control icons (e.g., close, minimize,
    ...
    /**
     * Sets the inset margin around the window controls (e.g., close, minimize,
     * and maximize buttons).
     *
     * @param newValue the new inset margin
     */
    ...
    public void setDefaultCloseOperation(int newValue) {
        set(PROPERTY_DEFAULT_CLOSE_OPERATION, newValue);
    }

    /**
     * Sets the overall height of the <code>WindowPane</code>, including its
     * border. This value will override any setting of the
     * <code>contentHeight</code> property.
     *
    ...
    /**
     * Sets whether the window can be maximized via a provided button in the
     * title bar.
     *
     * @param newValue true if the window can be maximized
     */
    public void setMaximizeEnabled(boolean newValue) {
        set(PROPERTY_MAXIMIZE_ENABLED, newValue);
    }
    ...
    /**
     * Sets whether the window can be minimized via a provided button in the
     * title bar.
     *
     * @param newValue true if the window can be minimized
     */
    public void setMinimizeEnabled(boolean newValue) {
        set(PROPERTY_MINIMIZE_ENABLED, newValue);
    }
    ...
    public void setModal(boolean newValue) {
        ...
        modal = newValue;
        firePropertyChange(MODAL_CHANGED_PROPERTY, oldValue, newValue);
    }
    ...
    public void setMovable(boolean newValue) {
        set(PROPERTY_MOVABLE, newValue);
    }

    /**
     * Sets the animation time for the window opening effect. A value of 0 (the
     * default) indicates the window will be immediately opened.
     *
     * @param newValue the new animation time, in milliseconds
     */
    public void setOpenAnimationTime(int newValue) {
        set(PROPERTY_OPEN_ANIMATION_TIME, newValue);
    }
    ...
    public void setResizable(boolean newValue) {
        set(PROPERTY_RESIZABLE, newValue);
    }
    ...
    /**
     * Sets the overall width of the <code>WindowPane</code>, including its
     * border. This value will override any setting of the
     * <code>contentWidth</code> property.
     *
     ...
     * Performs no operation by default. The client is responsible for
     * configuring the window appropriately.
     */
