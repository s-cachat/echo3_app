...
implements SerialPropertyPeer {
    ...
    throws SerialException {        
        try {
            ...
            LayoutData layoutData = (LayoutData) propertyClass.getDeclaredConstructor().newInstance();
            ...
            return layoutData;
        } catch (ClassNotFoundException | SerialException | InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | NoSuchMethodException ex) {
