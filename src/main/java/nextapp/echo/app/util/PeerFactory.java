    ...
    public PeerFactory(String resourceName, ClassLoader classLoader) {
        try {
            ...
            while (it.hasNext()) {
                ...
                Object peer = peerClass.getDeclaredConstructor().newInstance();
                objectClassNameToPeerMap.put(objectClassName, peer);
            }
        } catch (ClassNotFoundException | IOException | InstantiationException | IllegalAccessException | InvocationTargetException | NoSuchMethodException ex) {
