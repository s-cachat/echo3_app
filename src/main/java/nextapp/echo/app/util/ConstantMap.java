...
public class ConstantMap {
    ...
    public void add(int constantValue, String constantName) {
        dualMap.put(constantName, constantValue);
        dualMap.put(constantValue, constantName);
    }
    ...
    public String get(int constantValue) {
        return (String) dualMap.get(constantValue);
    }
    ...
    public int get(String constantName, int defaultValue) {
        ...
        return constantValue == null ? defaultValue : constantValue;
    }
}
