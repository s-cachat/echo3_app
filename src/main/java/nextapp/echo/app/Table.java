...
public class Table extends BorderedComponent {
    ...
    public void setAutoCreateColumnsFromModel(boolean newValue) {
        ...
        firePropertyChange(AUTO_CREATE_COLUMNS_FROM_MODEL_CHANGED_PROPERTY, oldValue, newValue);
    }
    ...
    public void setHeaderVisible(boolean newValue) {
        ...
        firePropertyChange(HEADER_VISIBLE_CHANGED_PROPERTY, oldValue, newValue);
    }
    ...
    public void setRolloverEnabled(boolean newValue) {
        set(PROPERTY_ROLLOVER_ENABLED, newValue);
    }
    ...
    private void setSelectedIndices(int[] selectedIndices) {
        ...
        ListSelectionModel _selectionModel = getSelectionModel();
        _selectionModel.clearSelection();
        for (int i = 0; i < selectedIndices.length; ++i) {
            _selectionModel.setSelectedIndex(selectedIndices[i], true);
        }
    ...
    public void setSelectionEnabled(boolean newValue) {
        set(PROPERTY_SELECTION_ENABLED, newValue);
    }
