...
implements Pane, PaneContainer {
    ...
    public int getOrientation() {
        ...
        return orientation == null ? ORIENTATION_VERTICAL : orientation;
    }
    ...
    public void setAutoPositioned(boolean newValue) {
        set(PROPERTY_AUTO_POSITIONED, newValue);
    }
    /**
    ...
    public void setOrientation(int newValue) {
        set(PROPERTY_ORIENTATION, newValue);
    }
    ...
    public void setSeparatorVisible(boolean newValue) {
        set(PROPERTY_SEPARATOR_VISIBLE, newValue);
    }
