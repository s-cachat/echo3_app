...
/**
 * A <code>Style</code> implementation which may be modified. Note that
 * modifications to the <code>Style</code> will not necessarily be reflected in
 * <code>Component</code>s that use the <code>Style</code> unless the
 * <code>Component</code>s are specifically informed of the changes, i.e., by
 * resetting the shared style of a <code>Component</code>. As such, shared
 * <code>Style</code>s should not be updated once they are in use by
 * <code>Component</code>s, as it will result in undefined behavior.
 */
public class MutableStyle
    ...
    /**
     * An <code>Iterator</code> which returns the names of properties which are
     * set in the style.
     */
    ...
    public class IndexedPropertyValue
        ...
        public Object getValue(int index) {
            if (indicesToValues == null) {
                ...
                return indicesToValues.get(index);
            }
        }

        /**
         * Returns the set property indices as an <code>Integer</code>-returning
         * <code>Iterator</code>.
         *
        ...
        public boolean hasValue(int index) {
            return indicesToValues != null && indicesToValues.containsKey(index);
        }
        ...
        private void setValue(int index, Object value) {
            ...
            indicesToValues.put(index, value);
        }
    }
    ...
    /**
     * Sets a property of the <code>Style</code>. If <code>propertyValue</code>
     * is null, the property will be removed.
     *
     * @param propertyName the name of the property
